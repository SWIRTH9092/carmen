...
SELECT * FROM COUNTRY WHERE continent = 'Europe' and region = 'Southern Europe' ORDER BY population ASC LIMIT 1;
...
SELECT * FROM COUNTRY 
    INNER JOIN COUNTRYLANGUAGE
        ON countrylanguage.countrycode = country.code
            WHERE country.continent = 'Europe' and country.region = 'Southern Europe' and countrylanguage.language = 'Italian' and countrylanguage.percentage = 100;
